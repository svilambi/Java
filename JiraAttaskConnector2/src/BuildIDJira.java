...
import com.atlassian.jira.issue.IssueManager;
	...
	public class BuildIDJira {
	   ...
	   // Folder inbox = store.getFolder("Inbox/Test"); 
	    Folder inbox = store.getFolder("Inbox/to_do");
	   ...
	   // term = new AndTerm(term, maxDateTerm);
	    ...
	    //  Message[] messages = inbox.getMessages();
	      ...
	      for (int i = n-1;  i >= 0; --i) {
	         ...
	         //String mailLines[] = mailContent.split("commit ");
	         ...
	         for (int j = 0; j < mailLines.length; j++) {
	        	 ...
	        	 int index = mailLines[j].indexOf("commit ");
	        	 int userIndex = mailLines[j].indexOf("Author: ");
	        	 int userEndIndex = mailLines[j].indexOf("<o:",userIndex+5);
	        	 //String index1 = "Changeset:";
	        	 //System.out.println("index:"+index);  
	        	 while (index > 0) {
	        	     //System.out.println(index);
	        	     changeSet = mailLines[j].substring(index+6, index+47 );
	        	     //user= mailLines[j].substring(userIndex+6, userEndIndex); 
	        	     user= mailLines[j].substring(userIndex+7, userEndIndex);   
	            	    	 ...
	            	    	 String assigneeName="";
	            	        	...
	            	        	try{
	          					...
	          					//String resp = invokePostMethod(auth, BASE_URL+"/rest/api/2/issue/"+str+"/comment", editIssueData);
	            					...
	            					String buildID = invokeGetMethod(auth, BASE_URL+"/rest/api/2/issue/"+str+"?fields=customfield_10501");
	            					System.out.println("+++++Build ID is: "+buildID);
	            					
	            					JSONObject test= issueFields.getJSONObject(buildID);
	            					
	            					
	            					
	            				
	            					
	            					String resp = invokePostMethod(auth, BASE_URL+"/rest/api/2/issue/"+str+"/customfield_10501", "testing");
	            					//invokePutMethod(auth, BASE_URL+"/rest/api/2/issue/"+str+"/customfield_10501", "testing");
	            					
	            					System.out.println("post method resuls: "+resp);
	            					String buildID1 = invokeGetMethod(auth, BASE_URL+"/rest/api/2/issue/"+str+"?fields=customfield_10501");
	            					System.out.println("@@@@@ Build ID1 is: "+buildID1);
	     ...
	     //apr18//					System.out.println(invokePostMethod(auth, BASE_URL+"/rest/api/2/issue/"+str+"/transitions", editIssueData2));
	            				////Important///////	
	            				...
	            				/////Important//////
	            					...
	            					System.out.println("%%%%%%%"+assigneeData);
	            	//apr18//		invokePutMethod(auth, BASE_URL+"/rest/api/2/issue/"+str+"/assignee", assigneeData);
